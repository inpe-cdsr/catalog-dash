...
$ docker build -t registry.dpi.inpe.br/inpe-cdsr/catalog-dash:0.0.5 -f docker/prod.Dockerfile . --no-cache
```

Push image to registry:

```
$ docker push registry.dpi.inpe.br/inpe-cdsr/catalog-dash:0.0.5
```
